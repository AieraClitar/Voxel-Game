...
// 🔧 FIX: Uses a double-sided flat plane instead of a hollow box to prevent grey borders
...
export class AIController {
    ...
    spawnMob(id, type, x, y, z, weaponType, faceType) {
        ...
        // 🔧 FIX: Parses the authoritative variant assignment directly from the server string
        if (type === 'zombie') {
            let variant = 1;
