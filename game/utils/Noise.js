export class SimpleNoise {
    ...
    random(x, z) {
        // Deterministic fractional sine wave hash (Replaces broken bitwise math)
    ...
    getNoise(x, z) {
        ...
        // Cosine interpolation for perfectly smooth, non-grid-like hills
        ...
        return (i1 * (1 - fZ) + i2 * fZ) * 2.0 - 1.0; // Maps to -1 to 1
    }
}