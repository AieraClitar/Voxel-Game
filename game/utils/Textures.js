...
export const Textures = {
    generate: function(type) {
        try {
            // VALIDATION SYSTEM: Prevent missing assets from crashing the renderer
            ...
            // --- ENVIRONMENT & BLOCKS ---
            if (type === 'grass_top') { fillBase('#4CAF50'); addNoise(15, 0.15); } // Vibrant Grass
            ...
            else if (type === 'snow') { fillBase('#ffffff'); addNoise(5, 0.05); } // Soft Snow
            else if (type === 'ice') { fillBase('#a0d8ef'); addNoise(5, 0.1); ctx.fillStyle = 'rgba(255,255,255,0.3)'; ctx.fillRect(0, 0, 16, 2); ctx.fillRect(0, 6, 16, 1); ctx.fillRect(10, 0, 1, 16); } // Smooth Ice
            else if (type === 'water') { fillBase('#1ca3ec'); addNoise(10, 0.15); ctx.fillStyle = 'rgba(255,255,255,0.2)'; ctx.fillRect(0, 2, 16, 1); } // Seamless Water base
            else if (type === 'lava') { fillBase('#ff3300'); addNoise(50, 0.5); ctx.fillStyle = '#ffaa00'; for(let i=0; i<12; i++) { ctx.fillRect(Math.random()*16, Math.random()*16, 2, 2); } } // Emissive Lava
            ...
            // --- MOBS ---
                ...
                ctx.fillStyle = '#ff0000'; ctx.fillRect(2, 4, 4, 3); ctx.fillRect(10, 4, 4, 3); // Red eyes
                ctx.fillStyle = '#111'; ctx.fillRect(3, 5, 2, 1); ctx.fillRect(11, 5, 2, 1); // Pupils
                ctx.fillStyle = '#224018'; ctx.fillRect(5, 10, 6, 2); // Mouth
                if (type === 'zombie_face_var1') { ctx.fillStyle = '#8b0000'; ctx.fillRect(1, 1, 2, 6); ctx.fillRect(12, 1, 3, 2); } // Bloody scars
                if (type === 'zombie_face_var2') { ctx.fillStyle = '#dddddd'; ctx.fillRect(2, 12, 3, 3); ctx.fillStyle = '#8f2020'; ctx.fillRect(2, 11, 4, 1); } // Exposed bone
            }
            ...
            // DEFAULT MAGENTA/BLACK ERROR TEXTURE (prevents crashes)
